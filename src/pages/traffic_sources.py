...
Vista de Fuentes de Tráfico del Growth Intelligence Dashboard
"""
...
def main():
    ...
    st.set_page_config(
        page_title="Fuentes de Tráfico - Marketing Dashboard",
    ...
    <div style='text-align: center; margin-bottom: 2rem;'>
        <h1 style='color: white; font-size: 2.5rem; margin-bottom: 0.5rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);'>🚀 FUENTES DE TRÁFICO</h1>
        <p style='color: white; font-size: 1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);'>Análisis de fuentes de tráfico y canales de adquisición</p>
    </div>
    """, unsafe_allow_html=True)
